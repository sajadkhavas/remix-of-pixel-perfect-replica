...
const filters = ["brand", "audience", "style", "movement", "price", "case-diameter", "case-material", "strap-material", "dial-color", "water-resistance", "availability", "discount"] as const;
...
const category = (id: string, slug: string, label: string): Category => ({
  ...
  seo: { title: `${label} | KRONOS`, description: `مجموعه ${label}.`, canonicalPath: `/shop/${slug}`, robots: "index,follow", structuredDataType: "CollectionPage" },
...
export const FIXTURE_CATEGORIES: readonly Category[] = [
  {
    ...
    seo: { title: "فروشگاه ساعت | KRONOS", description: "کاوش مجموعه ساعت‌ها.", canonicalPath: "/shop", robots: "index,follow", structuredDataType: "CollectionPage" },
    allowedFilterKeys: filters,
    allowedSortKeys: sorts,
    indexability: "index",
    breadcrumb: createBreadcrumb([{ type: "home", label: "خانه", href: "/" }, { type: "shop", label: "فروشگاه" }]),
  },
