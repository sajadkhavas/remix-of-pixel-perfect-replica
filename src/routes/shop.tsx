...
export const Route = createFileRoute("/shop")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "همه ساعت‌های موجود در کرونوس با فیلتر دسته، برند و مرتب‌سازی هوشمند.",
      },
  ...
  return (
    <>
      <PageHero
        eyebrow="فروشگاه"
        title="کاوش کلکسیون"
        sub="جستجو در میان برترین ساعت‌های لوکس، اسپرت، هوشمند و کلاسیک."
      />
        ...
        <div className="container mx-auto">
          <div className="flex flex-col lg:flex-row gap-4 mb-6">
            ...
            <select
              ...
              className="bg-[#0c0c0c] border border-[#1E1E1E] px-4 py-3 text-sm text-[#F0EDE8] focus:border-[#C9A84C55] outline-none"
            >
              ...
              <button
                ...
                className={`shrink-0 px-4 py-2 text-xs tracking-wider uppercase border transition-colors ${
                  cat === c.slug
                    ...
                    : "border-[#1E1E1E] text-[#A8A8A8] hover:border-[#C9A84C44]"
                }`}
              >
                {c.name}
              </button>
          ...
          {list.length === 0 ? (
            <div className="text-center py-20 border border-[#1E1E1E]">
              ...
              <Link
                ...
                className="inline-block mt-4 text-[#C9A84C] text-sm border-b border-[#C9A84C44]"
              >
                پاک کردن فیلترها
              </Link>
            </div>
