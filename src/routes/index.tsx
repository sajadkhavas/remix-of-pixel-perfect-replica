...
const EditorialSection = lazy(() => import("@/components/sections/EditorialSection").then(m => ({ default: m.EditorialSection })));

export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "کرونوس — فروشگاه ساعت لوکس | KRONOS" },
      { name: "description", content: "مرجع تخصصی ساعت‌های لوکس، اسپرت و هوشمند: Rolex، Omega، Patek Philippe، G-Shock، Apple Watch با ضمانت اصالت." },
